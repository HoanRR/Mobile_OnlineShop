...
public class CartService {
        ...
        public CartResponse getMyCart() {
                ...
                User user = userRepository.findByUsername(username) // Đổi tên hàm này theo code của bạn (ví dụ:
                                                                    // findByEmail)
        ...
        public void addToCart(AddToCartRequest request) {
                ...
                Optional<CartDetail> existingDetailOpt = cartDetailRepository.findByCartAndProductVariant(cart,
                                variant);
